                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card text-center">
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    <a href="index.html">
                                        <span><img src="{{asset('/images/logo-dark.png')}}" alt="" height="28"></span>
                                    </a>
                                </div>
                                <h1 class="text-error">{{$code}}</h1>
                            <h4 class="text-uppercase text-danger mt-3">{{$message}}</h4>
                            <p class="text-muted mt-3">
                                ...
                                <a class="btn btn-success mt-3" href="/"><i class="mdi mdi-home mr-1"></i> Return Home</a>
