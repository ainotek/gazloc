...
@section('content')
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-10">
                        ...
                        <div class="banner-text-wrap text-center">
                            ...
                            <h1  data-animate="fadeInUp" data-delay=".55">{{__('With mineralo')}}  <br> {{__('get delivered at your door.')}}</h1>
                            <a href="{{route('front.order')}}" class="btn"  data-animate="fadeInUp" data-delay=".7">{{__('Order now')}}</a>
                        </div>
                        <!-- End of banner text -->
                        <div class="banner-image"  data-trigger="parallax_layers">
                            <div class="row">
                                <div class="col-12">
                                    <img src="{{asset('')}}/img/banner/bottle.png" alt="" class="bottle">
                                    <div class="figure-caption">
                                        <div class="image-sell-offer">
                                            <h5><span>Livrer</span> en 2 H</h5>
                                        </div>
                                    </div>
                                    <div class="banner-image-wrap">
                                        <img src="{{asset('')}}/img/banner/ice.png" alt="" class="ice2" data-depth="0.3">
                                        <img src="{{asset('')}}/img/banner/ice.png" alt="" class="ice1" data-depth="0.3">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="single-feature-inner text-center">
                        <div class="feature-icon"><img src="{{asset('')}}/img/icons/water-bottle.svg" class="svg" alt=""></div>
                ...
                <div class="col-md-6 col-lg-3">
                    <!-- single feature inner -->
                    <div class="single-feature-inner text-center">
                        <div class="feature-icon"><img src="{{asset('')}}/img/icons/glass-of-water.svg" class="svg" alt=""></div>
                ...
                <div class="col-md-6 col-lg-3">
                    <!-- single feature inner -->
                    <div class="single-feature-inner text-center">
                        <div class="feature-icon"><img src="{{asset('')}}/img/icons/laboratory(1).svg" class="svg" alt=""></div>
                ...
                <div class="col-md-6 col-lg-3">
                    <!-- single feature inner -->
                    <div class="single-feature-inner text-center">
                        <div class="feature-icon"><img src="{{asset('')}}/img/icons/laboratory.svg" class="svg" alt=""></div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="single-counter-inner text-center">
                                            <div class="counter-image">
                                                <img src="{{asset('')}}/img/icons/water-bottle(2).svg" class="svg" alt="">
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single-team-member text-center">
                        <img src="{{asset('')}}/img/team/team1.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <!-- single team member -->
                    <div class="single-team-member text-center">
                        <img src="{{asset('')}}/img/team/team4.png" alt="">
                        <div class="member-info">
                            <h4>Camila Rose</h4>
                            <p>Officer</p>
                            <!-- team social area -->
                ...
                <div class="col-lg-3 col-sm-6">
                    <!-- single team member -->
                    <div class="single-team-member text-center">
                        <img src="{{asset('')}}/img/team/team2.png" alt="">
                        <div class="member-info">
                            <h4>Jessica Brown</h4>
                            <p>Co-Founder</p>
                            <!-- team social area -->
                ...
                <div class="col-lg-3 col-sm-6">
                    <!-- single team member -->
                    <div class="single-team-member text-center">
                        <img src="{{asset('')}}/img/team/team3.png" alt="">
                        <div class="member-info">
                            <h4>Mike Hardson</h4>
                            <p>Manager</p>
                            <!-- team social area -->
                    ...
                    <div class="testionial-carousel-wrap">
                        <div class="owl-carousel testimonial-carousel">
                            ...
                            <div class="single-testimonial">
                                <img src="{{asset('')}}/img/qort-icon.png" class='qurt-icon1' alt="">
                                ...
                                <div class="testimonial-author media">
                                    <img src="{{asset('')}}/img/team/author1.png" alt="">
                            ...
                            <div class="single-testimonial">
                                ...
                                <p>There are many variations of passages of available but the majority have alteration in some form by inject humour or random words which don't look even slightly they will believe you.</p>
                                <div class="testimonial-author media">
                                    <img src="{{asset('')}}/img/team/author2.png" alt="">
                                    <div class="testimonial-author-deg">
                                        <h4>Jessica Brown</h4>
                                        <p>Co Founder</p>
                                    </div>
                            ...
                            <div class="single-testimonial">
                                ...
                                <p>There are many variations of passages of available but the majority have alteration in some form by inject humour or random words which don't look even slightly they will believe you.</p>
                                <div class="testimonial-author media">
                                    <img src="{{asset('')}}/img/team/author3.png" alt="">
                                    <div class="testimonial-author-deg">
                                        <h4>Paul Smith</h4>
                                        <p>Officer</p>
                                    </div>
    ...
    <!-- End of our location -->
    @include('front.partials.parteners', ['data' => '$data'])
@stop
