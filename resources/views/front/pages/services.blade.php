    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="single-bottle-inner text-center">
                    <div class="bottle-image">
                        <img src="{{asset('')}}/img/icons/water-bottle.svg" alt="" class="svg">
                    </div>
                    <div class="single-bottle-text">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="single-bottle-inner text-center">
                    <div class="bottle-image">
                        <img src="{{asset('')}}/img/icons/water-bottle(2).svg" alt="" class="svg">
                    </div>
                    <div class="single-bottle-text">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="single-bottle-inner text-center">
                    <div class="bottle-image">
                        <img src="{{asset('')}}/img/icons/water-bottle(1).svg" alt="" class="svg">
                    </div>
                    <div class="single-bottle-text">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="single-bottle-inner text-center">
                    <div class="bottle-image">
                        <img src="{{asset('')}}/img/icons/big-bottle-of-water-with-handle.svg" alt="" class="svg">
                    </div>
                    <div class="single-bottle-text">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="single-blog-inner about-me">
                    ...
                    <div class="post-image">
                        <a href="#">
                            <img src="{{asset('')}}/img/blog/blog4.png" alt="">
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="single-blog-inner about-me">
                    ...
                    <div class="post-image">
                        <a href="#">
                            <img src="{{asset('')}}/img/blog/blog5.png" alt="">
                        </a>
                    </div><!--/.End of  blog image -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="single-blog-inner about-me">
                    ...
                    <div class="post-image">
                        <a href="#">
                            <img src="{{asset('')}}/img/blog/blog6.png" alt="">
                        </a>
                    </div><!--/.End of  blog image -->
