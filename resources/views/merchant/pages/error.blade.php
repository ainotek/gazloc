        ...
        <div class="col-12 col-md-5 col-xl-4 my-5">
            ...
            <div class="text-center">
                ...
                <p class="text-muted mb-4">
                    On dirait que vous avez atterri ici par accident ?
                </p>

                <!-- Button -->
                <a href="{{route('marchand.dashboard')}}" class="btn btn-lg btn-primary">
...
<!-- Mirrored from dashkit.goodthemes.co/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2019 23:43:29 GMT -->
</html>
