                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <a href="project-overview.html" class="avatar avatar-4by3">
                                        <img src="{{asset('')}}/img/avatars/projects/project-5.jpg" alt="..." class="avatar-img rounded">
                                    </a>
                        ...
                        <div class="card-body text-center">
                            <div class="row justify-content-center">
                                <div class="col-12 col-xl-10">
                                    ...
                                    <!-- Image -->
                                    <img src="{{asset('')}}/img/illustrations/happiness.svg" alt="..." class="img-fluid mt-n5 mb-4" style="max-width: 272px;">
